  ...
  <aside class="sidebar" :aria-label="collapsed ? t('sidebar.collapsedNavigation') : t('sidebar.navigation')">
    ...
    <div class="sidebar-section">
      ...
      <div class="source-picker">
        ...
        <button :class="['source-item', { active: platform === '' }]" :title="t('sidebar.allSources')" :aria-label="t('sidebar.allSources')" @click="emit('selectPlatform', '')"><i class="source-glyph all">{{ t('sidebar.allGlyph') }}</i><span>{{ t('sidebar.allSources') }}</span></button>
        ...
        <button :class="['source-item', { active: platform === 'doubao' }]" :title="t('app.platformDoubao')" :aria-label="t('app.platformDoubao')" @click="emit('selectPlatform', 'doubao')"><i class="source-glyph doubao">{{ t('sidebar.doubaoGlyph') }}</i><span>{{ t('app.platformDoubao') }}</span></button>
