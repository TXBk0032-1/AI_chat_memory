...
export const lightThemes: ThemeDefinition[] = [
  {
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      extInfo: {
        '--color-app-background': 'rgba(247, 249, 250, 0.65)',
        '--color-main-background': 'rgba(255, 255, 255, 0.88)',
  ...
  },
  {
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      extInfo: {
        '--color-app-background': 'rgba(244, 247, 251, 0.65)',
        '--color-main-background': 'rgba(255, 255, 255, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
        '--color-badge-primary': 'var(--color-primary)',
  ...
  },
  {
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      extInfo: {
        '--color-app-background': 'rgba(243, 246, 249, 0.65)',
        '--color-main-background': 'rgba(255, 255, 255, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
        '--color-badge-primary': 'var(--color-primary)',
  ...
  },
  {
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      extInfo: {
        '--color-app-background': 'rgba(253, 249, 242, 0.65)',
        '--color-main-background': 'rgba(255, 255, 255, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
        '--color-badge-primary': 'var(--color-primary)',
  ...
  },
  {
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      extInfo: {
        '--color-app-background': 'rgba(253, 245, 245, 0.65)',
        '--color-main-background': 'rgba(255, 255, 255, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
        '--color-badge-primary': 'var(--color-primary)',
  ...
  },
  {
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      extInfo: {
        '--color-app-background': 'rgba(254, 246, 247, 0.65)',
        '--color-main-background': 'rgba(255, 255, 255, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
        '--color-badge-primary': 'var(--color-primary)',
  ...
  },
  {
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      extInfo: {
        '--color-app-background': 'rgba(250, 245, 253, 0.65)',
        '--color-main-background': 'rgba(255, 255, 255, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
        '--color-badge-primary': 'var(--color-primary)',
  ...
  },
  {
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      extInfo: {
        '--color-app-background': 'rgba(243, 247, 248, 0.65)',
        '--color-main-background': 'rgba(255, 255, 255, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
        '--color-badge-primary': 'var(--color-primary)',
  ...
  },
  {
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      extInfo: {
        '--color-app-background': 'rgba(245, 246, 248, 0.65)',
        '--color-main-background': 'rgba(255, 255, 255, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
        '--color-badge-primary': 'var(--color-primary)',
  ...
  },
  {
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      extInfo: {
        '--color-app-background': 'rgba(244, 246, 254, 0.65)',
        '--color-main-background': 'rgba(255, 255, 255, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
        '--color-badge-primary': 'var(--color-primary)',
...
export const darkThemes: ThemeDefinition[] = [
  {
    ...
    config: {
      ...
      extInfo: {
        '--color-app-background': 'rgba(23, 27, 30, 0.70)',
        '--color-main-background': 'rgba(32, 37, 40, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
        '--color-badge-primary': 'var(--color-primary)',
  ...
  },
  {
    ...
    config: {
      ...
      font: 'rgb(229, 229, 229)',
      extInfo: {
        '--color-app-background': 'rgba(20, 28, 26, 0.70)',
        '--color-main-background': 'rgba(27, 38, 35, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
      },
    },
  },
  {
    ...
    config: {
      ...
      font: 'rgb(229, 229, 229)',
      extInfo: {
        '--color-app-background': 'rgba(15, 23, 42, 0.70)',
        '--color-main-background': 'rgba(23, 33, 56, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
      },
    },
  },
  {
    ...
    config: {
      ...
      font: 'rgb(229, 229, 229)',
      extInfo: {
        '--color-app-background': 'rgba(24, 18, 43, 0.70)',
        '--color-main-background': 'rgba(34, 27, 58, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
      },
    },
  },
  {
    ...
    config: {
      ...
      font: 'rgb(229, 229, 229)',
      extInfo: {
        '--color-app-background': 'rgba(28, 25, 23, 0.70)',
        '--color-main-background': 'rgba(38, 34, 32, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
      },
    },
  },
  {
    ...
    config: {
      ...
      font: 'rgb(229, 229, 229)',
      extInfo: {
        '--color-app-background': 'rgba(18, 18, 18, 0.70)',
        '--color-main-background': 'rgba(26, 26, 26, 0.88)',
        '--color-nav-font': 'var(--color-primary)',
      },
    },
  },
  ...
  if (isDark) {
    return {
      ...
      config: {
        ...
        extInfo: {
          '--color-app-background': 'rgba(23, 27, 30, 0.70)',
          '--color-main-background': 'rgba(30, 36, 40, 0.88)',
          '--color-nav-font': 'var(--color-primary)',
          '--color-badge-primary': 'var(--color-primary)',
